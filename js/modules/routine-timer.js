...
(function() {
    ...
    window.RoutineTimer = {
        ...
        schedule: [
            ...
            { id: 'water',     group: 'Afternoon', hour: 17, minute: 50, icon: '🚰', label: 'Water Bottle',             chime: 'dinner', type: 'chore' },
            { id: 'snacks', group: 'Afternoon', hour: 17, minute: 55, icon: '🥨', label: 'Restock snacks',   chime: 'dinner',  type: 'chore' },
